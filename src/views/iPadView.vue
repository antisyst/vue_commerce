<template>
    <main class="action_state">
      <h1 class="route_store_title">iPad Products</h1>
      <div class="product_container">
      <a v-for="product in iPadProducts" :key="product.url" class="product_item" :href="`/product/${product.url}`">
  ...
  data() {
    return {
      iPadProducts: products.filter((product: any) => product.category === 'iPad'),
